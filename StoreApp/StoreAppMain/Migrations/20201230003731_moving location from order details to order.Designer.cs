...
namespace StoreApp.Migrations
{
    ...
    [Migration("20201230003731_moving location from order details to order")]
    partial class movinglocationfromorderdetailstoorder
    {
            ...
            modelBuilder.Entity("StoreApp.Order", b =>
                {
                    ...
                    b.HasOne("StoreApp.StoreLocation", "Store")
                        .WithMany()
                        .HasForeignKey("StoreLocationId");
